            ...
            <div className="col-md-6">
              <div className="myLeftCtn">
                <div className="box">
                  ...
                  <p>
                    If you’re applying for a tertiary place, or a new job, or a
                    new relationship, it helps to be able to point to the
                    unselfish efforts you’re putting in for the community.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="myRightCtn">
                <form onSubmit={handelSubmit} className="myForm text-center">
                  ...
                  <input type="submit" className="butt" name="" value="Login" />
                  <input
                    type="button"
                    className="butt"
                    name=""
