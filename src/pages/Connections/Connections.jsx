    ...
    <div className="connections-container">
      <div className="connections-box">
        <div className="connections-head">
          ...
          <form className="connections-head-form" onSubmit={handleSearch}>
            <input
              type="text"
              value={searchStr}
              ...
              style={{
                ...
                padding: openSearch ? "0.5rem 1rem" : "0.5rem 0",
              }}
            />
            <button
              onClick={() => {
              ...
              style={{
                borderRadius: openSearch ? "0 500px 500px 0" : "500px",
              }}
            >
          ...
          {userConnections.length > 0 && connections.length > 0 && (
            <div className="connections-row">
              <div className="connections-row-head">
                ...
                >
                  <span className="aavesh-btn-text">View All</span>
                </button>
              </div>
