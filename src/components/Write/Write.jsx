...
function Write({load}) {
    ...
    const handelPost=async (e)=>{
        ...
        const postInfo={
            ...
            if(desc===""){
                try {
                    const res=await axios.post("https://tegniescorporation.tech/api/post",postInfo);
                    console.log(res);
                  } catch (err) {
                    console.log(err);
                  }
            ...
            <div className="write-wrapper">
                <div className="write-container">
                    ...
                    <div className="write-desc">
                        <label htmlFor="desc"><img src={"https://tegniescorporation.tech/images/"+user.photo} alt="" />{user.name}</label>
